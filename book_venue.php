        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="credit-info">
                    ...
                    <p><strong>Booking cost:</strong> $<?php echo number_format($venue['hourly_rate'] * 2, 2); ?> (2 hours)</p>
                    <p><strong>Balance after booking:</strong> $<?php echo number_format($user_credit - ($venue['hourly_rate'] * 2), 2); ?></p>
                </div>
            </div>
                    ...
                    <div class="booking-form">
                        ...
                        <form id="booking-form" method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Maximum capacity: <?php echo $venue['capacity']; ?> people</small>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <a href="venues.php?sport_type=<?php echo urlencode($sport_type); ?>" class="btn-cancel">Cancel</a>
